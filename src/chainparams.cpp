...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Test bonfara monero fork 18/11/2017";
...
//          vMerkleTree: 12630d16a9
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1511024400, vin, vout, 7000000000);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1511024400;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 6307075;
...
//        //end
        ...
        assert(hashGenesisBlock == uint256("0x00000b7074ac1904f5d1ec8d71dc6dc5db5c3a8072282b347390b21969ce15fc"));
        assert(genesis.hashMerkleRoot == uint256("0x6e79accf5c2bc7769347657909801e6f59b94d16410d036f3e285d4bb00a4c8e"));
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000f0f5ca749415ee0d561b3db104b1f3ae877dee41c2ef82ff3ef9fbb123ea"));
        assert(genesis.hashMerkleRoot == uint256("0x6e79accf5c2bc7769347657909801e6f59b94d16410d036f3e285d4bb00a4c8e"));
...
public:
    CRegTestParams() {
        ...
        nDefaultPort = 18444;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x6c0965105ddaf31fd1f335d758723ec678fa41aab03c4552675a73ba1f38457b"));
