...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Test bonfara monero fork 17/11/2017";
...
//          vMerkleTree: 12630d16a9
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1510964952, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1510969546;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 6056246;
...
//        //end
        ...
        assert(hashGenesisBlock == uint256("0x00000af2018c2956ce311ae0bc0a6c71bf63219ed3f7a9ca788ada6183f874eb"));
        assert(genesis.hashMerkleRoot == uint256("0x7a247e9b8bfbed9f12c16a1837a47671b6dcaadbc2c72d3fde355a93ef12167c"));
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000f756ec7555bbf5f664a3cc58b1ce1e6e77e819f292ff6d5eb8a1d14e71c2"));
        assert(genesis.hashMerkleRoot == uint256("0x7a247e9b8bfbed9f12c16a1837a47671b6dcaadbc2c72d3fde355a93ef12167c"));
...
public:
    CRegTestParams() {
        ...
        nDefaultPort = 18444;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("299170b99d3b4c86866585d276db72e564760037fb3aad32058933b5929fdab7"));
