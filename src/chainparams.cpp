...
//          vMerkleTree: 12630d16a9
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1510964952;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 5125426;
...
//        //end
        ...
        assert(hashGenesisBlock == uint256("0x000005358af491e9728e984d951a90093ea3e8423b9d883572ff998e7a831b48"));
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000093d1b190d1364c5f9ec7c282e50a682e127da65b89aa5ed6f948515e6816"));
        assert(genesis.hashMerkleRoot == uint256("0x7a247e9b8bfbed9f12c16a1837a47671b6dcaadbc2c72d3fde355a93ef12167c"));
...
public:
    CRegTestParams() {
        ...
        nDefaultPort = 18444;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x51debe9ccdda0fdc67e822eb076cbd0a805496ca9f8a4efe3a0b120cbe5fd97d"));
