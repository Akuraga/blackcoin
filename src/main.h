...
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 1; }
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1511024400; }

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10000 * 60; }
